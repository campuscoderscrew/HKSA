...
function About() {
  return (
    <div>
      ...
      {/* Activities */}
      <div className='flex flex-col justify-center items-center mr-[250px] ml-[250px]'>
        <span className="font-['Tiro_Bangla'] text-[30px] mb-[50px] mr-[100px] ml-[100px]">Activities</span>
        <span className='font-["ZCOOL_XiaoWei"] font-[56px] text-[20px]'> We do a variety of fun activities with our members throughout the school year. Some examples include:</span>
        
        <div className='font-["ZCOOL_XiaoWei"] text-[20px] flex flex-row flex-wrap gap-10 mr-[200px] ml-[200px] mt-[40px] mb-[120px]'>
          <div className=''>
