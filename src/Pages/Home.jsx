...
function Home() {
  return (
    <div>
      ...
      {/* Immersion */}
      <div class="w-9/10 h-fit my-12 mx-auto">
        <img src="../src/Images/Home/immersion-decor-right.svg" alt="" class="block ml-auto relative" />
        ...
        <img src="../src/Images/Home/immersion-decor-left.svg" alt="" class="block relative" />
      </div>
      ...
      <div class="w-fit h-fit relative">
        ...
        <div style={{position: "absolute", top: "37.5%", left: "40.5%"}}>
          <MemoriesPhoto imageURL={memoryPlaceholder} />
        </div>
        <div style={{position: "absolute", top: "40.5%", left: "70%"}}>
          <MemoriesPhoto imageURL={memoryPlaceholder} />
        </div>
      ...
      {/* Learn More */}
      <div class="w-9/10 h-fit mx-auto mt-[-24px] mb-12 text-center">
        <img src="../src/Images/Home/immersion-decor-left.svg" alt="" class="block top-18 relative rotate-90" />
        ...
        <img src="../src/Images/Home/immersion-decor-left.svg" alt="" class="block mt-[-48px] ml-auto relative rotate-270" />
      </div>
    </div>
  );
}
