  ...
  return (
    <div class="bg-[#330008] font-['Inter']">
      ...
      <div class="w-9/10 h-fit md:-mt-12 mb-12 mx-auto overflow-hidden">
        <img src="/images/home/immersion-decor-right.svg" alt="" class="block ml-auto relative w-1/4 lg:w-auto h-auto top-8" />
        {/* Main content */ }
        <div class="w-9/10 m-auto -mt-10 flex flex-col gap-2 text-center">
          ...
          <div class="w-4/5 m-auto lg:mt-20 px-4 md:px-0 flex gap-10 lg:gap-25 justify-center">
            <img src="/images/home/immersion-1.png" alt="A woman in traditional clothing with an oil paper umbrella." class="w-1/3 lg:w-[calc(33%-66px)] h-auto rounded-sm drop-shadow-sm drop-shadow-[#AD721F]" />
            <img src="/images/home/immersion-2.png" alt="A variety of dim sum dishes in steamers" class="w-1/3 lg:w-[calc(33%-66px)] h-auto relative rounded-sm drop-shadow-[#AD721F]" />
            <img src="/images/home/immersion-3.png" alt="Red paper lanterns" class="w-1/3 lg:w-[calc(33%-66px)] h-auto relative rounded-sm drop-shadow-[#AD721F]" />
          </div>
        </div>

        <img src="/images/home/immersion-decor-left.svg" alt="" class="block relative w-1/6 lg:w-auto h-auto -mt-8" />
      </div>
        ...
        <div class="w-9/10 h-full  my-15 flex flex-col md:flex-row items-center gap-12.5 md:gap-15">
          ...
          <div class="w-full md:w-1/2 flex flex-col text-center">
            ...
            <div class="relative mt-12.5">
              <img class="absolute -top-2 left-0" src="/images/home/opening-quote.svg" alt="" />
              <p class="text-left text-white text-[20px] md:text-[24px] 2xl:text-[30px] traacking-tight leading-8 border-8 [border-image-source:url(/images/home/quote-box.svg)] [border-image-slice:10] p-6">Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua. Ut enim ad minim veniam, quis nostrud exercitation ullamco laboris nisi ut aliquip ex ea commodo consequat.</p>
              <img class="absolute -bottom-2 right-0" src="/images/home/closing-quote.svg" alt="" />
            </div>
      ...
      <div class="w-9/10 h-fit mx-auto mb-20 text-center overflow-hidden">
        ...
        <div className='flex flex-col items-center gap-10 mt-8 lg:-mt-8'>
          <div class="flex gap-4">
            <img class="relative top-4 w-[10%] lg:w-full" src="/images/home/learn-more-decor.svg" alt="" />
        ...
        <img src="/images/home/immersion-decor-left.svg" alt="" class="block ml-auto relative rotate-270 w-1/6 lg:w-auto -mt-2" />
      </div>
      <Footer />
    </div>
  );
