...
const Navbar = () => (
  <header className="sticky top-0 flex justify-between items-center z-50 shadow-md bg-white">
    ...
    <label htmlFor="nav-toggle" className="md:hidden flex items-center justify-center w-10 h-10 cursor-pointer absolute right-4 top-4 z-30">
      {/* Hamburger Icon */}
      <svg className="nav-hamburger-icon transition-all duration-300 ease-in-out text-red-500 w-8 h-8 absolute left-1/2 top-1/2 -translate-x-1/2 -translate-y-1/2" xmlns="http://www.w3.org/2000/svg" width="32" height="32" viewBox="0 0 24 24">
        <path fill="none" stroke="currentColor" strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" d="M4 6h16M4 12h16M4 18h16" />
      </svg>
      {/* Close Icon */}
      <svg className="nav-close-icon transition-all duration-300 ease-in-out text-red-500 w-8 h-8 absolute left-1/2 top-1/2 -translate-x-1/2 -translate-y-1/2" xmlns="http://www.w3.org/2000/svg" width="32" height="32" viewBox="0 0 24 24">
